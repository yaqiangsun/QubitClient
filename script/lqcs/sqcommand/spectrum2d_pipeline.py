...
def get_spectrum2d_hdf5_res():
    # 1.数据采集
    # result = sq.spectroscopy_auto(q2lu7,  zpa_scan=np.arange(-0.2, 0.2, 0.002))
    # result = sq.s(q2lu7,  zpa_scan=np.arange(-0.2, 0.2, 0.002))
    result = sq.spectroscopy(q3lu7, freq=np.arange(4, 3, -0.01),zpa=np.arange(-1.5,0,0.3),update=False)
