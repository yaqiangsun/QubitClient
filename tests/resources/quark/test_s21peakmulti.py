...
from resources.quark.anaylsis.inception import s21multi
from resources.quark.anaylsis.visualization import plot_s21multi
import matplotlib.pyplot as plt


def test_s21peakmulti(task_key, base_dir):
...
def main():
    task_key = "s21"
    base_dir = "tmp/data/s21_full_scan"
    test_s21peakmulti(task_key, base_dir)
