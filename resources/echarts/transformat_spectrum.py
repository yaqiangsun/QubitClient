...
def transform_spectrum_npy_and_processed_data(dict_list):
    savenamelist = []
...
def main():
    ...
    trans_all_npy = transform_spectrum_npy_and_processed_data(dict_list)# trans_all_npy的数据格式参考format_spectrum.json
