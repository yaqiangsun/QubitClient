...
def plot_pic(file_path):
    ...
    for each_qubit_name, each_qubit_info  in image.items():
        ...
        value1 = each_qubit_info[1]
        value2 = each_qubit_info[2]

        value3 = each_qubit_info[3]
        value4 = each_qubit_info[4]

        plt.figure(figsize=(6, 4))
        plt.plot(x_axis, value1, label='Data 1')
        plt.plot(x_axis, value2, label='Data 2')
        plt.plot(x_axis, value3, label='Data 3')
        plt.plot(x_axis, value4, label='Data 4')
