...
from resources.quark.anaylsis.inception import nnpowershift
from resources.quark.anaylsis.visualization import plot_nnpowershift
import matplotlib.pyplot as plt


def test_nnpowershift(task_key, base_dir):
