...
def transform_spectrum2dscope_npy_and_processed_data(url, api_key, dict_list):
    savenamelist = []
...
def main():
    ...
    trans_all_npy = transform_spectrum2dscope_npy_and_processed_data(API_URL, API_KEY, dict_list)  # trans_all_npy的数据格式参考format_s21vflux.json
