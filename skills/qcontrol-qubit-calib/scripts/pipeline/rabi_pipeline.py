...
Usage:
    ...
    2. Example:
        python -m skills.qcontrol-qubit-calib.scripts.pipeline.rabi_pipeline -q q1ld5 -u True -c 0.6 
...
def parse_args():
    ...
    parser.add_argument("--pi-len", "-pl", type=float, default=60, help="Pulse length")
...
def get_rabi_hdf5_res(args):
    ...
    pi_amp_star_original = qubit_ctrl_client.query_param(qname=qname, key="pi_amp_star")
    pi_len_star_original = qubit_ctrl_client.query_param(qname=qname, key="pi_len_star")
    ...
    try:
        ...
        set_params = {
            ...
            "pi_amp_star": pi_amp_star_original,
            "pi_len_star": pi_len_star_original
        }
        ...
        if args.update:
            ...
            if qname in update_amp_map:
                target_pigate_amp_star = float(update_amp_map[qname])

                target_values = [target_pigate_amp_star]
                ...
                new_full_params["pi_amp_star"] = target_pigate_amp_star
