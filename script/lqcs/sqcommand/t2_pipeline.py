...
from analysis.inception import t2fit
from analysis.visualization import plot_t2fit
...
def get_t2_hdf5_res():
    ...
    # 另一种测t2方法
    # result = sq.spinecho_t2(q2lu7, 
    #                         delay=[0, 100e-6],
    #                         fringeFreq=[5e6, 100e6],
    #                         ms=1.0,
    #                         update=False)
    ...
    # 4.绘图
    pure_name = 'q2lu7'
    img_save_path = f'{SAVE_PLOT_FOLDER}/t2_{pure_name}.png'
