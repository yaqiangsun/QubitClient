...
def plot_pic(file_path):
    ...
    for each_qubit_name, each_qubit_info  in image.items():
        ...
        # 上图
        ax1.plot(x_axis, value, color = 'red')
        ax1.plot(x_axis, value2, color = 'blue')
        ax1.set_ylabel('Amp')
        ...
        # 下图
        if len(each_qubit_info) >= 5:
            value5 = each_qubit_info[4]
            value6 = each_qubit_info[5]
            
            ax2.plot(value5, value6, color = 'green')
