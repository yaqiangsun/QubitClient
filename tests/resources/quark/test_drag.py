...
from resources.quark.anaylsis.inception import allxy_drag
from resources.quark.anaylsis.visualization import plot_drag
...
def main():
    task_key = "drag"
    base_dir = "tmp/data/drag"
    test_drag(task_key, base_dir)
