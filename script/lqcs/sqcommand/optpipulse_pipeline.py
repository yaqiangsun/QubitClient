...
def get_optpipulse_hdf5_res():
    # 1.数据采集

    # result = sq.piamp(q2lu7, fc=None, amp=2)
    # result = sq.piamp(q2lu7, amp=2)

    # 2.找到最新的指定task_type的hdf5文件内容
    # data, pure_name = get_latest_content(ROOT_FOLDER, task_type="pi")
    ...
    # img_save_path = f'{SAVE_PLOT_FOLDER}/nns21peak_{pure_name}.png'
    # fig_list = plot_nns21(data, analysis_result, save_path=img_save_path)
